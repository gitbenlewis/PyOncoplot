...
| --- | --- | --- | --- |
| `goal_plot_1.png` | `gen.goal_plot_1.png` | ggoncoplot/R | large BRCA oncoplot |
| `goal_plot_2.png` | `gen.goal_plot_2.png` | ggoncoplot/R | small README oncoplot |
| `goal_plot_3.png` | `gen.goal_plot_3.png` | ggoncoplot/R | README basic oncoplot |
| `goal_plot_4.png` | `gen.goal_plot_4.png` | ggoncoplot/R | README oncoplot with marginal bars |
| `goal_plot_5.png` | `gen.goal_plot_5.png` | ggoncoplot/R | README oncoplot with clinical metadata |
| `goal_plot_6.png` | `gen.goal_plot_6.png` | ggoncoplot/R | package mark recreation |
| `goal_plot_7.png` | `gen.goal_plot_7.png` | ggoncoplot/R | static interactive oncoplot snapshot |
| `goal_plot_8.png` | `gen.goal_plot_8.png` | ggoncoplot/R | package comparison table |
| `goal_plot_9.png` | `gen.goal_plot_9.png` | ggoncoplot/R | compact package comparison table |
| `goal_plot_10.png` | `gen.goal_plot_10.png` | ggoncoplot/R | lasso-selection scatterplot |
| `goal_plot_11.png` | `gen.goal_plot_11.png` | ggoncoplot/R | multimodal selection panel |
| `goal_plot_12.png` | `gen.goal_plot_12.png` | ggoncoplot/R | multimodal selection panel |
| `goal_plot_13.png` | `gen.goal_plot_13.png` | ggoncoplot/R | multimodal panel with lasso highlight |
| `goal_plot_14.png` | `gen.goal_plot_14.png` | ggoncoplot/R | compact paper-style GBM oncoplot |
| `goal_plot_15.png` | `gen.goal_plot_15.png` | other R-based paper | compact BRCA oncoplot |
| `goal_plot_16.png` | `gen.goal_plot_16.png` | other R-based paper | compact CSSC alteration matrix |
| `goal_plot_17.png` | `gen.goal_plot_17.png` | other R-based paper | GBM clinical/molecular panel |
| `goal_plot_18.png` | `gen.goal_plot_18.png` | Python/fuc | basic AML oncoplot |
