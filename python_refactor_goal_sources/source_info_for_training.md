...
python_refactor_goal_sources/
  ...
  make_oncoplots.py                direct public oncoplot() gallery renderer
  make_other_gallery_plots.py      custom gallery renderers
  recreate_gallery.py              thin gallery orchestration CLI
...
- All source reference plots are PNG files named `goal_plot_NN.png`.
...
- Clean generated counterparts are configured in `config.yaml` as
  `gen.goal_plot_01.png` through `gen.goal_plot_21.png`.

## Source Sections

Goal plots are numbered by source family:

| Range | Section | Description |
| --- | --- | --- |
| `goal_plot_01.png` - `goal_plot_13.png` | ggoncoplot/R | ggoncoplot README, paper, package, and multimodal examples |
| `goal_plot_14.png` - `goal_plot_16.png` | other R-based paper | Published oncoplot-style figures from non-ggoncoplot papers |
| `goal_plot_17.png` - `goal_plot_21.png` | Python/fuc | fuc tutorial and structural-variation examples |

## Generated Counterparts

| Goal plot | Clean generated plot | Source section | Renderer intent |
| --- | --- | --- | --- |
| `goal_plot_01.png` | `gen.goal_plot_01.png` | ggoncoplot/R | large BRCA oncoplot |
| `goal_plot_02.png` | `gen.goal_plot_02.png` | ggoncoplot/R | small README oncoplot |
| `goal_plot_03.png` | `gen.goal_plot_03.png` | ggoncoplot/R | README basic oncoplot |
| `goal_plot_04.png` | `gen.goal_plot_04.png` | ggoncoplot/R | README oncoplot with marginal bars |
| `goal_plot_05.png` | `gen.goal_plot_05.png` | ggoncoplot/R | README oncoplot with clinical metadata |
| `goal_plot_06.png` | `gen.goal_plot_06.png` | ggoncoplot/R | package mark recreation |
| `goal_plot_07.png` | `gen.goal_plot_07.png` | ggoncoplot/R | static interactive oncoplot snapshot |
| `goal_plot_08.png` | `gen.goal_plot_08.png` | ggoncoplot/R | compact package comparison table |
| `goal_plot_09.png` | `gen.goal_plot_09.png` | ggoncoplot/R | lasso-selection scatterplot |
| `goal_plot_10.png` | `gen.goal_plot_10.png` | ggoncoplot/R | multimodal selection panel |
| `goal_plot_11.png` | `gen.goal_plot_11.png` | ggoncoplot/R | multimodal selection panel |
| `goal_plot_12.png` | `gen.goal_plot_12.png` | ggoncoplot/R | multimodal panel with lasso highlight |
| `goal_plot_13.png` | `gen.goal_plot_13.png` | ggoncoplot/R | compact paper-style GBM oncoplot |
| `goal_plot_14.png` | `gen.goal_plot_14.png` | other R-based paper | compact BRCA oncoplot |
| `goal_plot_15.png` | `gen.goal_plot_15.png` | other R-based paper | compact CSSC alteration matrix |
| `goal_plot_16.png` | `gen.goal_plot_16.png` | other R-based paper | GBM clinical/molecular panel |
| `goal_plot_17.png` | `gen.goal_plot_17.png` | Python/fuc | basic AML oncoplot |
| `goal_plot_18.png` | `gen.goal_plot_18.png` | Python/fuc | AML metadata oncoplot, unsorted |
| `goal_plot_19.png` | `gen.goal_plot_19.png` | Python/fuc | AML metadata oncoplot, sorted |
| `goal_plot_20.png` | `gen.goal_plot_20.png` | Python/fuc | structural-variation panel |
| `goal_plot_21.png` | `gen.goal_plot_21.png` | Python/fuc | AML metadata oncoplot, survival-filtered |
